    ...
    const std::chrono::nanoseconds& pastProjectedBaseHorizon)
{
    ...
    autoregressiveState.previousVelMannInput = input; //TODO here use a value coming from config file
...
bool VelMANNAutoregressive::setInput(const Input& input)
{
    ...
    //TODO this is for the instantaneous vel at the time t
    ...
    //TODO this comes from the actual past trajectory, we are already considering us to be at the input, so at the time t, and this stuff is for the slot t-1 to t
